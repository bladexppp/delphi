object FrmPesquisaModelo: TFrmPesquisaModelo
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Pesquisa De Modelo'
  ClientHeight = 370
  ClientWidth = 657
  Color = clBtnFace
  ...
  object Modelo: TFDQuery
    ...
    object ModeloCOD_MODELO: TIntegerField
      FieldName = 'COD_MODELO'
      Origin = 'COD_MODELO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object ModeloDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 200
    end
    object ModeloFABRICANTE: TStringField
      FieldName = 'FABRICANTE'
      Origin = 'FABRICANTE'
      Size = 100
    end
