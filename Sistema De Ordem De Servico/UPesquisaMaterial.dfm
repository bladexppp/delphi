object FrmPesquisaMaterial: TFrmPesquisaMaterial
  Left = 0
  Top = 0
  ...
  object Material: TFDQuery
    Connection = DMDados.Bdados
    SQL.Strings = (
      'select *'
      '  from material'
      '   where descricao like :WMATERIAL'
      '   AND FLG_ATIVO ='#39'S'#39' '
      '   order by descricao')
    Left = 440
    Top = 184
    ParamData = <
    ...
    object MaterialCOD_PRODUTO: TIntegerField
      FieldName = 'COD_PRODUTO'
      Origin = 'COD_PRODUTO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object MaterialDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      Size = 200
    end
    object MaterialVLR_UNITARIO: TBCDField
      FieldName = 'VLR_UNITARIO'
      Origin = 'VLR_UNITARIO'
      Precision = 18
      Size = 2
