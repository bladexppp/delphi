...
begin
  if os.FieldByName('SITUACAO').AsString='Finalizado' then
    begin
      Mensagem('Imposivel Alterar! Ordem De Serviço Encontra-se Finalizada');
      cmdNovo.SetFocus;
      abort;
    end;
...
begin
   if os.FieldByName('SITUACAO').AsString='Finalizado' then
    begin
      Mensagem('Imposivel Deletar! Ordem De Serviço Encontra-se Finalizada');
      cmdNovo.SetFocus;
      abort;
    end;
...
begin
  ...
  begin
    if Pergunta('Deseja Realmente Finalizar Essa Ordem De Serviço?') then
    begin
      os.Edit;
